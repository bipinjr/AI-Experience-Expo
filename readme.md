...
[![Projects](https://img.shields.io/badge/Projects-10-6C63FF?style=for-the-badge)](#project-shortlist)
[![Focus](https://img.shields.io/badge/Focus-Interactive%20AI-00C2A8?style=for-the-badge)](#our-vision)
[![Audience](https://img.shields.io/badge/Audience-PU%20Students-FF9F1C?style=for-the-badge)](#visitor-experience)
[![Platform](https://img.shields.io/badge/Platform-Web%20%7C%20AI%20%7C%20CV-1E293B?style=for-the-badge)](#technology-toolkit)
...
```mermaid
flowchart LR
    A[🎯 Choose a Project] --> B[🧪 Test Existing Repo / Demo]
    B --> C{✅ Runs Reliably?}
    C -- Yes --> D[🎨 Customise UI, Story & Interaction]
    C -- No --> E[🛠️ Build a Focused Version]
    E --> D
    D --> F[👥 Test With Students]
    F --> G[🛟 Add Fallback Mode]
    G --> H[📤 Upload to Shared Repository]
    H --> I[✨ Expo Ready]
```
